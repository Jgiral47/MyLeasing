...
namespace MyLeasing.Web.Data.Entity
{
    public class SeedDb
    {
        ...
        private async Task CheckPropertyTypesAsync()
        {
            ...
            {
                _context.PropertyTypes.Add(new Entity.PropertyType { Name = "Apartamento" });
                _context.PropertyTypes.Add(new Entity.PropertyType { Name = "Casa" });
                _context.PropertyTypes.Add(new Entity.PropertyType { Name = "Negocio" });
